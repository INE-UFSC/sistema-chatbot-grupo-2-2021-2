...
lista_bots = [BotZangado("Yoda"), BotZangado('Luke'), BotFeliz('João'), BotFeliz('Gabriel'), BotManezinho('Augusto'), BotMinerin('Thiago'),BotLegal('Feijao (grupo 4)'),BotCansado('Pedro (Grupo 3)'),BotMusical('Slash (grupo 1)'),BotJose('José (grupo 1)')]
